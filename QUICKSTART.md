...
Формула доставки уже зашита в backend:
- цена доставки за 1 м³ = `(расстояние × 35) + 650`
- доставка считается минимум за `6 м³`
- если объём дробный, для доставки он округляется вверх
...
4. Выберите репозиторий `АВТОМАТИЗИРОВАННЫЙ_ОТДЕЛ_ПРОДАЖ`
5. Настройки:
